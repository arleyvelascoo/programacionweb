document.addEventListener("DOMContentLoaded", function() { 
  ...
  yes.addEventListener('click', () => {
    gustoform.innerHTML = '<div class="form-row"><div class="form-group col-md-6"><label for="inputAddress">Color Favorito</label><input type="color" class="form-control" id="colorfavorite"></div><div class="form-group col-md-6"><label for="inputPassword4">Marca de Carro Favorita</label><input type="text" class="form-control" id="marcafavorita"></div></div><div class="form-row"><div class="form-group col-md-6"><label for="inputAddress">Estilo de Carro Favorito</label><input type="text" class="form-control" id="style"></div><div class="form-group col-md-6"><label for="inputPassword4">Modelo del carro que más le gusta</label><input type="text" class="form-control" id="model"></div></div>';
  })
